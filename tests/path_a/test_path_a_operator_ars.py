...
class RunbookTests(unittest.TestCase):
    def test_runbooks_cover_the_operator_contract(self):
        ...
        self.assertIn("launchctl submit", drill)
        self.assertIn("launchctl remove", drill)
        self.assertIn("nohup", drill)
        ...
        self.assertIn("soak_length", soak)
        self.assertIn("soak_truncated", soak)
        self.assertIn("cold_truncated", (ROOT / "docs" / "path-a" / "ar8-cold.md").read_text())
        self.assertIn("TRUNCATED", soak)
        self.assertIn("nohup", soak)
        self.assertIn("SHORT", soak)
        self.assertIn("FAILS", soak)
        self.assertIn("INVALIDS", soak)
        self.assertIn("completion_tokens", soak)
